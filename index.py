...
class handler(BaseHTTPRequestHandler):
  ...
  def mine(self, raw_data: dict) -> dict:
      ...
      data['rand_str'] = rand_arr.hex()
      data['hex_digest'] = hex_digest
      data['mining_time'] = round(end-start, 2)
      data['credit'] = "https://www.facebook.com/KENNAKAP/"
      return data
  ...
  def do_GET(self):
    ...
    try:
      ...
      self.end_headers()
      self.wfile.write(json.dumps({"error": "ส่งค่ามาไม่ครบ", "credit": "https://www.facebook.com/KENNAKAP/"}).encode('utf-8'))
      return
